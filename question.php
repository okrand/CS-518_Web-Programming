...
<body>    
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "INSERT INTO ANSWERS (QUEST_ID, USER_ID, ANSWER) VALUES (".$_SESSION["QNumber"].", ".$_SESSION["UserID"].", '".$answer."');";
    ...
    //List answers
    $query = "SELECT * FROM ANSWERS WHERE QUEST_ID =".$_SESSION["QNumber"].";";
