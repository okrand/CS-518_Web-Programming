...
CREATE TABLE `ANSWERS` (
  ...
  `DATE_ANSWERED` datetime NOT NULL DEFAULT NOW(),
  PRIMARY KEY (`ID`)
...
CREATE TABLE `QUESTIONS` (
  ...
  `DATE_ASKED` datetime NOT NULL DEFAULT NOW(),
...
INSERT INTO `QUESTIONS` (INSERT INTO QUESTIONS (ID, ASKER_ID, QUESTION_TITLE, QUESTION_PHRASE, TAG1, TAG2, TAG3, POINTS, DATE_ASKED) VALUES 
(1, 1000, 'testQTitle', 'testQPhrase', 'testtag1', 'testtag2', 'testtag3', 12 '2016-10-03 16:44:13');
